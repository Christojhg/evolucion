...
=======
                  ...
                  <form action="#"  enctype="multipart/form-data" method="post"  id="form_store">
                    @csrf
                    <button type="submit" class="btn btn-success rounded-circle float-right" style="margin-right: 5px;">
...
<<<<<<< Updated upstream
                    <button type="submit" class="btn btn-success float-right">
                      Enviar a correo
=======
                    <button type="submit" class="btn btn-info rounded-circle float-right">
