...
<div class="container p-5">
    <div class="row">
        <div class="col ">
            <img class="brand-image img-circle elevation-3 img-thumbnail rounded mx-auto d-block" src="{{asset('/logo_empresa/').'/'.$company->photo}}" style="width: 600px; height: 600px;" alt="">
        </div>
        <div class="col">
            <div class="row p-2">
                <div class="col-6">
